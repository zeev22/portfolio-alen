  ...
  const experiences = [
    {
      ...
      description: "As a System Analyst at LinkyTech, I am responsible for analyzing, designing, and optimizing the company's software systems to meet business requirements. This role involves collaborating with cross-functional teams, assessing system performance, and implementing solutions that improve efficiency and functionality.",
      period: "January 2024 - April 2024",
      company: "LinkyTech"
    },
    {
      title: "Frontend Developer / Quality Assurance",
description: "Developed the 'Aquasnap: Multi-Fish Identification App' using Java/Kotlin as part of the Capstone Project. The app allows users to identify various fish species, providing an interactive and informative experience. Contributed to both frontend development and quality assurance, ensuring responsive design, seamless functionality, and rigorous testing to deliver a high-quality application.",
  ...
  return (
    <section className="experiences-container">
      ...
      <div className="experiences-grid-container">
        <h3 className="section-title">Key Experiences</h3>
        <div className="experiences-grid">
          {experiences.map((exp, index) => (
            <div key={index} className="experience-card">
              <h4>{exp.title}</h4>
              <p className="experience-period">{exp.company ? `${exp.company} - ${exp.period}` : exp.period}</p>
      ...
      <div className="certificates-container">
        <h3 className="section-title">Online Course Certificates</h3>
        <Carousel 
        ...
        >
          {certificates.map((cert) => (
            <NavLink key={cert.id} to={`/certificate/${cert.id}`} className="cert-item">
              <div className="cert-preview">
                <img src={cert.image} alt={`Preview of Certificate ${cert.id}`} className="cert-thumb" />
              </div>
